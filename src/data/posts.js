export const posts = [
  ...
  // {
  //   slug: "heart-of-ustad-hotel",
  //   title: "🎞️ The Heart of Ustad Hotel: Discovering Our 'Why'",
  //   date: "December 10, 2024",
  //   author: "Samin Yeasar",
  //   image: "/blogs/ustad-hotel.jpg",
  //   content: `
  //     <p>This movie has changed my perspective on life. I learned a simple yet valuable lesson while watching this scene: the importance of knowing the "why." No matter what we are doing in our lives, we must have a strong reason behind it. Even if we don’t enjoy a particular task, we should focus on why we need to do it and for whom we are persevering. Understanding our reasons can help us cultivate passion, even for things we dislike. </p>
  //   `,
  // },
];
